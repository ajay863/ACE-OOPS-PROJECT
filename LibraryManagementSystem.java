...
public class LibraryManagementSystem {
    public static void main(String[] args) {
        ...
        Book book1 = new Book("B001", "Rich Dad Poor Dad", "Robert Kiyosaki");
        Book book2 = new Book("B002", "Think Rich,Grow Rich", "Nepolean Hill");
        library.addBook(book1);
        library.addBook(book2);

        // Add members to the library
        Member member1 = new Member("M001", "Ajay");
        Member member2 = new Member("M002", "Vijay");
